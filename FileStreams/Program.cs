...
namespace FileStreams
{
    public class Program
    {
        ...
        {
            TextWriter tw = File.CreateText(filenameText);
        ...
        {
            TextReader tr = File.OpenText(filenameText);
        ...
        {
            Stream fs = File.Create(filenameBinary);
        ...
        {
            Stream fr = File.OpenRead(filenameBinary);
